...
describe('Edit Campaign Theme', () => {
    ...
    it('Update Campaign theme with invalid api and valid method', () => {
    ...
    it('Update Campaign theme with invalid api and invalid method', () => {
    ...
    it('Update Campaign theme with valid api and invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Update Campaign theme with valid api and valid method with super admin permission.', () => {
        const accessToken = Cypress.env('accessToken');
        const randomName = Array.from({ length: 60 }, () => Math.random().toString(36)[2]).join('');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme with empty', () => {
        const accessToken = Cypress.env('accessToken');
        const randomName = Array.from({ length: 60 }, () => Math.random().toString(36)[2]).join('');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme title with upperlimit+1.', () => {
        const accessToken = Cypress.env('accessToken');
        const randomName = Array.from({ length: 60 }, () => Math.random().toString(36)[2]).join('');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme url as empty.', () => {
        const accessToken = Cypress.env('accessToken');
        const randomName = Array.from({ length: 60 }, () => Math.random().toString(36)[2]).join('');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme url as integer.', () => {
        const accessToken = Cypress.env('accessToken');
        const randomName = Array.from({ length: 60 }, () => Math.random().toString(36)[2]).join('');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme with valid api and valid method with master admin permission.', () => {
    ...
    it('Update Campaign theme with valid api and valid method with site admin permission.', () => {
    ...
    it('Update Campaign theme with valid api and valid method with reseller admin permission.', () => {
        ...
        cy.then('Edit the reseller campaign theme', () => {
            cy.request({
                method: 'PUT',
    ...
    it('Update Campaign theme with valid api and valid method with site read admin permission.', () => {
