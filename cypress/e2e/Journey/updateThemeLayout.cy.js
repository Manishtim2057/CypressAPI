...
describe('Campaign Theme Layout list', () => {
    ...
    let themeLayoutId;
    let resellerThemeLayoutId;
    let layoutChildrenId;
    let resellerLayoutChildrenId;
    before(() => {
        cy.request({
            method: 'POST',
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                expect(response.body.body).to.have.property("id");
                expect(response.body.body.children[0]).to.have.property('id')

                const themeLayoutId = response.body.body.id;
                const layoutChildrenId = response.body.body.children[0].id;
                cy.readFile('cypress/fixtures/variables.json').then((data) => {
                    const updatedData = { ...data, themeLayoutId, layoutChildrenId };
                    cy.writeFile('cypress/fixtures/variables.json', updatedData);
                });
            });
        });
        cy.then('Create Theme Layout with reseller permission', () => {
            ...
            cy.request({
                ...
                expect(response.body.body).to.have.property('id');
                expect(response.body.body.children[0]).to.have.property('id')
                const resellerThemeLayoutId = response.body.body.id;
                const resellerLayoutChildrenId = response.body.body.children[0].id;
                cy.readFile('cypress/fixtures/variables.json').then((data) => {
                    const updatedData = { ...data, resellerThemeLayoutId, resellerLayoutChildrenId };
                    cy.writeFile('cypress/fixtures/variables.json', updatedData);
                });
            });
        });
        ...
        cy.readFile('cypress/fixtures/variables.json').then((data) => {
            ...
            themeLayoutId = data.themeLayoutId
            resellerThemeLayoutId = data.resellerThemeLayoutId
            layoutChildrenId = data.layoutChildrenId
            resellerLayoutChildrenId = data.resellerLayoutChildrenId

        });
    });

    it('Update the Campaign layout with invalid api and valid method', () => {
    ...
    it('Update the Campaign layoutwith valid api and invalid method', () => {

        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'POST',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Update the Campaign layoutwith Invalid api and invalid method', () => {
    ...
    it('Update the Campaign layoutwith valid api and valid method', () => {
    ...
    it('Update the Campaign layout with Side Admin Permission', () => {
    ...
    it('Update the Campaign layout with Master Admin Permission', () => {
    ...
    it('Update the Campaign layout with Site Read Permission', () => {
    ...
    it('Update the Campaign layout with Reseller Admin Permission', () => {

        const resellerAdminAccessToken = Cypress.env('resellerAdminAccessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.resellerSiteId}/campaigns/${baseConfig.resellerLandingPageId}/layouts/${resellerThemeLayoutId}`,
            headers: {
                Authorization: `Bearer ${resellerAdminAccessToken}`,
            },
            qs: {
    ...
    it('Update the Campaign layoutwith Title as empty.', () => {
    ...
    it('Update the Campaign layoutwith Children title as empty.', () => {
    ...
    it('Update Campaign theme layout with Order and children Order as 0.', () => {
    ...
    it('Update Campaign theme layout with resourceId as invalid.', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource_type as invalid.', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource id as invalid for resource object.', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as invalid for resource object.', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type and resource id as invalid for resource object.', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as global Contact', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as global Link', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as global image', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as site Document', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as site Contact', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as site Link', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as site Image', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as Video', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as Site Video', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as Calculator', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as Dynamic Calculator', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
    ...
    it('Update Campaign theme layout with resource type as configed Documents', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
        ...
        cy.then('Update theme layout with Configed layouts', () => {
            cy.request({
                method: 'PUT',
                url: `${baseConfig.url}/sites/${baseConfig.siteId}/campaigns/${baseConfig.landingPageId}/layouts/${themeLayoutId}`,
                headers: {
    ...
    it('Update Campaign theme layout with resource type as configed Contacts', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
    ...
    it('Update Campaign theme layout with resource type as configed Links', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Update Campaign theme layout with resource type as configed Images', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
    ...
    it('Update the Campaign layout with children Id as Null.(Previous children Id should be Deleted/New Should Updated)', () => {
        ...
        cy.request({
            ...
            cy.log('Sites Response:', JSON.stringify(response));
            expect(response.status).to.eql(200, 'Check for Not found error');
            expect(response.body.body.children[0].id).to.not.eql(layoutChildrenId)
        })
    });
});