...
describe('Campaign Theme Layout list', () => {
    ...
    it('View list of the Campaign theme Layout with invalid api and invalid method', () => {
    ...
    it('View list of the Campaign theme Layout with valid api and invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('View list of the Campaign theme Layout with valid api and valid method with super admin permission.', () => {
    ...
    it('View list of the Campaign theme Layout with valid api and valid method with master admin permission.', () => {
    ...
    it('View list of the Campaign theme Layout with valid api and valid method with site admin permission.', () => {
    ...
    it('View list of the Campaign theme Layout with valid api and valid method with reseller admin permission.', () => {
    ...
    it('View list of the Campaign theme Layout with valid api and valid method with site read admin permission.', () => {
