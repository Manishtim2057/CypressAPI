...
let resellerVersion;
describe('Reorder Document on Pages and Resources.', () => {
    before(() => {
        cy.request({
            method: 'POST',
    ...
    it('Reorder Homepage resources with invalid Api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documentss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with valid Api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documents/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with invalid api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documentsss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/documents/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenReadPermission}`,
                        },
                        body: {
    ...
    it('Reorder Homepage Resources with Reseller Admin Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/documents/${resellerResourceID1}`,
                body: {
                    "order": 2
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/documents/${resellerResourceID2}`,
                body: {
                    "order": 4
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'GET',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/documents`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                qs: {
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/documents/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenResellerAdmin}`,
                        },
                        body: {
