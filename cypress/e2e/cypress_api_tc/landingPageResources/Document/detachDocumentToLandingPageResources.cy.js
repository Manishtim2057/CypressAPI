...
describe('Detach Landing Page Resources.', () => {
    before(() => {
        ...
        cy.log('Attach Documents')
        cy.then(() => {
            const accessToken = Cypress.env('accessToken');
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documents/${documentId}`,
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
                body: {
        ...
        cy.log('Get selected Document Id')
        cy.then(()=>{
            const accessToken = Cypress.env('accessToken');
            cy.request({
                method: 'GET',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documents`,
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
                failOnStatusCode: false,
    ...
    it('Detach Landing Pages Documents with Invalid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
    ...
    it('Detach Landing Pages Documents with valid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Detach Landing Pages Documents with Invalid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Detach Landing Pages Documents with Valid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/documents/${selectedResourceId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Detach Landing Pages Documents with All read Permission', () => {
    ...
    it('Detach Landing Pages Documents with MasterAdmin Permission', () => {
    ...
    it('Detach Landing Pages Documents with Site Admin Permission', () => {
    ...
    it('Detach Landing Pages Documents with Global Resource CRUD Permission', () => {
    ...
    it('Detach Landing Pages Documents with Reseller Admin Permission', () => {
        ...
        cy.log('Attach the Document To Pages and Resources.')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/documents/${resellerResourceID}`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                body: {
        ...
        cy.log('Detach the Document To Pages and Resources.')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'DELETE',
