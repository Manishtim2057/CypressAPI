...
let resellerVersion;
describe('Attach Documents on Pages and Resources.', () => {
    before(() => {
        cy.request({
            method: 'POST',
        ...
        cy.log('Get Ids of Documentss From Available Documentss');
        cy.then(() => {
            const accessToken = Cypress.env('accessToken');
            cy.request({
                method: 'GET',
    ...
    it('Attach Page Documents with Invalid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/documentsss/${documentId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Attach Page Documents with valid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Attach Page Documents with Invalid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Attach Page Documents with Valid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
    ...
    it('Attach Page Global Documents with MasterAdmin Permission', () => {
    ...
    it('Attach Page Resources with Reseller Admin Permission', () => {
        ...
        cy.log('Add the Site Documentss on the Reseller Site')
        cy.then(() => {
        ...
        cy.log('Fetch the Available List from Documents')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'GET',
        ...
        cy.log('Attach the Documents To Pages and Resources.')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'POST',
