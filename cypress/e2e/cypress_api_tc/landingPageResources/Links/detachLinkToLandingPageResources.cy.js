...
describe('Detach Landing Page Resources.', () => {
    before(() => {
        ...
        beforeEach(()=>{
        cy.log('Get Ids of Links From Available Links');
        cy.then(() => {
            const accessToken = Cypress.env('accessToken');
            cy.request({
                method: 'GET',
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/links/${linkId}`,
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
                body: {
    ...
    it('Detach Landing Pages Links with Invalid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
    ...
    it('Detach Landing Pages Links with valid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Detach Landing Pages Links with Invalid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Detach Landing Pages Links with Valid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/links/${selectedResourceId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Detach Landing Pages Links with All read Permission', () => {
    ...
    it('Detach Landing Pages Links with MasterAdmin Permission', () => {
    ...
    it('Detach Landing Pages Links with Site Admin Permission', () => {
    ...
    it('Detach Landing Pages Links with Global Resource CRUD Permission', () => {
    ...
    it('Detach Landing Pages Links with Reseller Admin Permission', () => {
        ...
        cy.log('Add the Site Links on the Reseller Site')
        cy.then(() => {
        ...
        cy.log('Fetch the Available List from Link')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'GET',
        ...
        cy.log('Attach the Link To Pages and Resources.')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/links/${resellerResourceID}`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                body: {
        ...
        cy.log('Detach the Link To Pages and Resources.')
        cy.then(() => {
            const accessTokenResellerAdmin = Cypress.env('accessTokenResellerAdmin');
            cy.request({
                method: 'DELETE',
