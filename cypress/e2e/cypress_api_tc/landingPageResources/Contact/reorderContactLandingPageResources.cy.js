...
let resellerVersion;
describe('Attach Contact on Pages and Resources.', () => {
    before(() => {
        cy.request({
            method: 'POST',
...
it('Reorder Homepage resources with invalid Api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contactss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with valid Api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with invalid api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contactsss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Reorder Homepage resource with valid Api and valid Method.', () => {
        ...
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contacts/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenReadPermission}`,
                        },
                        body: {
    ...
    it('Reorder Homepage Resources with Reseller Admin Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/contacts/${resellerResourceID1}`,
                body: {
                    "order": 2
                },
                qs: {
                ...
                cy.log('Sites Response:', JSON.stringify(response));
                expect(response.status).to.eql(200, 'Check for status of Contacts Attached');
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/contacts/${resellerResourceID}`,
                body: {
                    "order": 3
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/contacts/${resellerResourceID2}`,
                body: {
                    "order": 4
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'GET',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/contacts`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                qs: {
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/contacts/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenResellerAdmin}`,
                        },
                        body: {
