...
describe('Detach Landing Page Resources.', () => {
    before(() => {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/${contactId}`,
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
                body: {
    ...
    it('Detach Landing Pages Contacts with Invalid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contactsss/${selectedResourceId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Detach Landing Pages Contacts with valid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Detach Landing Pages Contacts with Invalid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Detach Landing Pages Contacts with Valid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/${selectedResourceId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Detach Landing Pages Contacts with All read Permission', () => {
    ...
    it('Detach Landing Pages Contacts with MasterAdmin Permission', () => {
    ...
    it('Detach Landing Pages Contacts with Site Admin Permission', () => {
    ...
    it('Detach Landing Pages Contacts with Global Resource CRUD Permission', () => {
    ...
    it('Detach Landing Pages Contacts with Reseller Admin Permission', () => {
