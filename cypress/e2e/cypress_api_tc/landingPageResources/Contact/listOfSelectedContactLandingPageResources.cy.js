import { baseConfig } from "../../../../fixtures/baseConfig";describe('Get Page Resources.', () => {
    ...
    it('Get Page Resources with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pagesss/${baseConfig.sitePageId}/contacts`,
            headers: {
    ...
    it('Get Page Resources with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pagesss/${baseConfig.landingPageId}/contacts`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
