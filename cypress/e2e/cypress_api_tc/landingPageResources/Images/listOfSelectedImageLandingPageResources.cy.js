import { baseConfig } from "../../../../fixtures/baseConfig";describe('Get Page Resources.', () => {
    ...
    it('Get Page Resources with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pagesss/${baseConfig.sitePageId}/image`,
            headers: {
    ...
    it('Get Page Resources with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pagesss/${baseConfig.landingPageId}/images`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('Get Page Resources with Global Resource CRUD Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                cy.log('Sites Response:', JSON.stringify(response));
                expect(response.status).to.eql(403, 'Check for status of image');
