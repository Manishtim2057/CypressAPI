...
describe('Get Site Available Resources.', () => {
    ...
    it('Get Site Available Contacts with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-imagesS`,
            headers: {
    ...
    it('Get Site Available Contacts with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-imagesSS`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Get image list with All read Permission', () => {
    ...
    it('Get image list with MasterAdmin Permission', () => {
    ...
    it('Get image list with Site Admin Permission', () => {
    ...
    it('Get image list with Global Resource CRUD Permission', () => {
    ...
    it('Get image list with Reseller Admin Permission', () => {
