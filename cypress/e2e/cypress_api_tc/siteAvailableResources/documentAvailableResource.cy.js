...
describe('Get Site Available Resources.', () => {
    before(() => {
        cy.request({
            method: 'POST',
    ...
    it('Get Site Available Contacts with Invalid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-documentsS`,
            headers: {
    ...
    it('Get Site Available Contacts with valid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
    ...
    it('Get Site Available Contacts with Invalid api and InValid method', () => {
        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-documentsSS`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Get Site Available Contacts with Valid api and Valid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Get document list with All read Permission', () => {
    ...
    it('Get document list with MasterAdmin Permission', () => {
    ...
    it('Get document list with Site Admin Permission', () => {
    ...
    it('Get document list with Global Resource CRUD Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                cy.log('Sites Response:', JSON.stringify(response));
                expect(response.status).to.eql(403, 'Check for status of documents');

            });
        });
    });
    it('Get document list with Reseller Admin Permission', () => {
