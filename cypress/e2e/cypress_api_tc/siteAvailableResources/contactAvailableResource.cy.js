...
// let contactId;
// let contactId1;
// let resellercontact1;
// let resellercontact2;
describe('Get Site Available Resources.', () => {
    ...
    it('Get Site Available Contacts with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-contactsS`,
            headers: {
    ...
    it('Get Site Available Contacts with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/available-contactsSS`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Get contact list with All read Permission', () => {
    ...
    it('Get contact list with MasterAdmin Permission', () => {
    ...
    it('Get contact list with Site Admin Permission', () => {
    ...
    it('Get contact list with Global Resource CRUD Permission', () => {
    ...
    it('Get contact list with Reseller Admin Permission', () => {
