...
describe('Read Global List', () => {
    ...
    it('Get the list of created links with valid api and valid method', () => {
...
it('Get the list of created links with valid api and invalid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'PUT',
        url: baseConfig.baseUrl + '/links',
...
it('Get the list of created links with Invalid  api and invalid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'PUT',
...
it('Get the list of created links with Invalid  api and Valid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'GET',
        url: baseConfig.baseUrl + '/linkss',
