...
describe('Edit Global Link', () => {
    ...
    it('Edit Global Link with invalid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
            url: baseConfig.baseUrl + '/sites/358/linkss/sdfsdfsdf',
            body: {
    ...
    it('Edit Global Link with valid api and invalid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
                url: baseConfig.baseUrl + '/links/28',
            body: {
    ...
    it('Edit Global Link with invalid api and invalid method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
    ...
    it('Edit Global Link with Title as Upperlimit + 1', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with Title as Empty', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with Title as Null', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with url as Null', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with url as invalid', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with Thumbnail url as invalid', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with Thumbnail url as null', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with status as invalid', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with open in external as invalid', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Global Link with All valid Fields', () => {
        const accessToken = Cypress.env('accessToken');
        ...
        cy.request({
            ...
            cy.log('Login Response:', JSON.stringify(response));
            expect(response.status).to.be.eql(200, 'Check Global link request is sucessful');
            expect(response.body.body).to.have.property('title');
            expect(response.body.body.title).to.eql('Cypress Automation Link')
            expect(response.body.body.description).to.eql(null)
            expect(response.body.body.status).to.eql(2)
