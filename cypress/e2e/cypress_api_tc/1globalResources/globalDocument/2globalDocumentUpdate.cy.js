...
describe('Edit Operations of the Document', () => {
    ...
    it('Edit Documents with Invalid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'PUT',
            url: baseConfig.baseUrl + '/documentss',
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('Edit Documents with Invalid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'POST',
            url: baseConfig.baseUrl + '/documentss/sadasd',
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('Edit Documents with valid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents with valid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as Upperlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as lowerlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as Upperlimit+1', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as empty', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as String.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents title as Integer.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents Description as Null.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents type as DOCX.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents type as xlsx.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents type as PPTX.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents type as Invalid.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents Thumbnail as type as GIF.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents with Thumbnail type as JPG.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents image type as PNG.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Edit Documents image type as JPEG.', () => {
        const accessToken = Cypress.env('accessToken');
