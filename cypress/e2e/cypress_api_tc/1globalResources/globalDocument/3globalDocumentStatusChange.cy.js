...
describe('Change Status of the Global Document', () => {     
    ...
    it('Change the status of Document with invalid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Change the status of Document with Invalid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('change the status of Document with valid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'POST',
            url: baseConfig.baseUrl + '/documents/1/status',
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('change the status of Document with valid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');

        cy.request({
            method: 'PUT',
            url: baseConfig.baseUrl + '/documents/'+documentId+'/status',
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
