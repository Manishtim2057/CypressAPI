...
describe('Read Global Contact', () => {
    ...
    it('Get the list of created Document with valid api and valid method', () => {
...
it('Get the list of created Document with valid api and invalid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'PUT',
...
it('Get the list of created Document with Invalid  api and invalid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'PUT',
...
it('Get the list of created Document with Invalid  api and Valid method', () => {
    const accessToken = Cypress.env('accessToken');
    cy.request({
        method: 'GET',
        url: baseConfig.baseUrl + '/contactss',
