...
describe('Change Status of the Global Contact', () => {
    let contactId;
    before(() => {
        cy.request({
            method: 'POST',
    ...
    it('change the status of Contact with valid api and Invalid method', () => {
        ...
        cy.request({
            method: 'POST',
            url: baseConfig.baseUrl + '/contacts/' + contactId + '/status', headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
        }).then((response) => {
    ...
    it('change the status of Contact with valid api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: baseConfig.baseUrl + '/contacts/' + contactId + '/status',
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('change the status of Contacts with valid api and valid method', () => {
