...
describe('Add Operations of the Document', () => {
    ...
    it('Add bulk global document with doc 1 with Invalid api and valid method', () => {
    ...
    it('Add bulk global document with doc 1 with Invalid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 with valid api and Invalid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 with valid api and valid method', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as Upperlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as lowerlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as Upperlimit+1', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as empty', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as String.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 title as Integer.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 Description as Null.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as PDF.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as DOCX.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as DOC.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as xlsx.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as xls.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as PPT.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as PPTX.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 type as Invalid.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 Thumbnail as type as GIF.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 with Thumbnail type as JPG.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 Thumbnail type as PNG.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 Thumbnail type as JPEG.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 with icon as null', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and 2 title as Upperlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and 2 title as lowerlimit.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and doc 2 title as empty', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and doc 2 title as String.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and doc 2 title as Integer.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and doc 2 Description as Null.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add bulk global document with doc 1 and doc 2 type as PDF.', () => {
        const accessToken = Cypress.env('accessToken');
    ...
    it('Add Image with image with All read Permission', () => {
    ...
    it('Add Image with image with MasterAdmin Permission', () => {
    ...
    it('Add Image with image with Site Admin Permission', () => {
    ...
    it('Add Image with image with Global Resource CRUD Permission', () => {
    ...
    it('Add Image with image with Reseller Admin Permission', () => {
