...
let contactId1;
let contactId;
describe('Change Status of Contact', () => {
    ...
    before(() => {
        ...
        cy.then(() => {
            ...
            cy.request({
                ...
                const contactId1 = response.body.body.data[0].id;
                const contactId2 = response.body.body.data[1].id;
    ...
    it('Change the status of Contact with valid api and Invalid method', () => {
        ...
        cy.request({
            method: 'GET',
            url: baseConfig.baseUrl + '/contacts/multiple/status',
            body: {
                "ids": [
    ...
    it('Change the status of Contact with Invalid api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: baseConfig.baseUrl + '/contacts/multiple/statussss',
            body: {
                "ids": [
                    contactId1, contactId
                ],
    ...
    it('Change the status of Contact with Invalid api and Invalid method', () => {
        ...
        cy.request({
            method: 'GET',
            url: baseConfig.baseUrl + '/contacts/multiple/statusss',
            body: {
                "ids": [
                    contactId1, contactId
                ],
