...
describe('View Usage of Contact with Super admin permission', () => {
    let contactId;
    ...
    it('Create and Attach Contacts with Invalid API and Valid Method.',()=>{
        const accessToken = Cypress.env('accessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contactss`,
            method: "POST",
            body:{
                "title": "Cypress Create and Attach Contact",
                "url": baseConfig.pdfContact,
    ...
    it('Create and Attach Contacts with Valid API and Invalid Method.',()=>{
        const accessToken = Cypress.env('accessToken');
        cy.request({
    ...
    it('Create and Attach Contacts with Invalid API and Invalid Method.',()=>{
        const accessToken = Cypress.env('accessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contactsss`,
            method: "POST",
            body:{
                "title": "Cypress Create and Attach Contact",
                "url": baseConfig.pdfContact,
    ...
    it('Create and Attach Contacts And View For the Resources in Usage',()=>{
        ...
        cy.request({
            ...
            contactId = response.body.body.id;
        ...
        cy.then('Verify the Contact Usage',()=>{
            const accessToken = Cypress.env('accessToken');
            cy.request({
                url : `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contacts/${contactId}/usage`,
                method: "GET",
                headers:{
                    Authorization:`Bearer ${accessToken}`, 
                },
    ...
    it('Create and Attach Contacts And View For the landing pages Resources in Usage',()=>{
        const accessToken = Cypress.env('accessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contacts`,
            method: "POST",
    ...
    it('Create and Attach Contacts And View For the Resources in Usage with master admin permission.',()=>{
    ...
    it('Create and Attach Contacts And View For the landing pages Resources in Usage with master admin permission.',()=>{
        const masterAdminAccessToken = Cypress.env('masterAdminAccessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contacts`,
            method: "POST",
    ...
    it('Create and Attach Contacts And View For the Resources in Usage with Site Admin permission',()=>{
    ...
    it('Create and Attach Contacts And View For the landing pages Resources in Usage with site admin permission',()=>{
        const siteAdminAccessToken = Cypress.env('siteAdminAccessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contacts`,
            method: "POST",
    ...
    it('Create and Attach Contacts And View For the Resources in Usage with Site Read permission',()=>{
    ...
    it('Create and Attach Contacts And View For the landing pages Resources in Usage with site Read permission',()=>{
        const siteReadAccessToken = Cypress.env('siteReadAccessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/contacts`,
            method: "POST",
    ...
    it('Create and Attach Contacts And View For the Resources in Usage with reseller admin permission.',()=>{
        ...
        cy.then('Verify the Contact Usage',()=>{
            const resellerAdminAccessToken = Cypress.env('resellerAdminAccessToken');
            cy.request({
                url : `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/contacts/${contactId}/usage`,
                method: "GET",
                headers:{
                    Authorization:`Bearer ${resellerAdminAccessToken}`, 
                },
    ...
    it('Create and Attach Contacts And View For the landing pages Resources in Usage with reseller admin permission.',()=>{
        const resellerAdminAccessToken = Cypress.env('resellerAdminAccessToken');
        cy.request({
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/contacts`,
            method: "POST",
