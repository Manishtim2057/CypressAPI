import { baseConfig } from "../../../../fixtures/baseConfig";describe('Config Contacts List', () => {
    ...
    it('Config Contact with Invalid api and valid Method', () => {
    ...
    it('Config Contact with Invalid api and Invalid Method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'POST',
            url: baseConfig.baseUrl + '/sites/' + baseConfig.siteId + '/contact-configsss',
    ...
    it('Config Contact with valid api and Invalid Method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'PUT',
    ...
    it('Config Contact with valid api and valid Method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
            url: baseConfig.baseUrl + '/sites/'+ baseConfig.siteId + '/contact-config',
