import { baseConfig } from "../../../../fixtures/baseConfig";describe('Config links List', () => {
    ...
    it('Config link with Invalid api and valid Method', () => {
        ...
        cy.request({
            ...
            body: {
                ...
                "thumbnail_url": "https://lycv2.blob.core.windows.net/lycv2/links/yaddBJ9ka7On0vhaWoWkVLKkHO9ouyO5Qb0ni2zG.png",
                "link_id": 5
              },
            headers: {
    ...
    it('Config link with valid api and valid Method', () => {
        const accessToken = Cypress.env('accessToken');
        cy.request({
            method: 'GET',
            url: baseConfig.baseUrl + '/sites/'+ baseConfig.siteId + '/link-config',
