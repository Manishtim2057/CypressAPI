...
describe('Delete Config document', () => {
    ...
    it('Delete Global Contact with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: baseConfig.baseUrl + '/sites/' + baseConfig.siteId + '/documentss-config',
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Delete Global document with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'DELETE',
            url: baseConfig.baseUrl + '/sitess/' + baseConfig.siteId + '/document-config',
            headers: {
                Authorization: `Bearer ${accessToken}`,
