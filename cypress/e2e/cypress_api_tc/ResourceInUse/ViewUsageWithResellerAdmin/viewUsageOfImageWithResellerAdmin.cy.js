import { baseConfig } from "../../../../fixtures/baseConfig";describe('View Usage of Image in Site', () => {
    let imageId;
    let resellerImageId;
    let siteImageId;
    ...
    before('Login With Reseller admin permission', () => {
        ...
        cy.then('Configured the Global Image', () => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/image-config`,
                body: {
 ...
 qs: {
    ...
    it('Attach Global Image In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/images/${globalImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
 ...
 qs: {
    ...
    it('Attach Global Image In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/images/${globalImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
 ...
 qs: {
    ...
    it('Detach Global Image From In-video Recommendation and Check For Usage.(Should be Unused)', () => {
        ...
        cy.then('Fetch for the Doc Usage.', () => {
            cy.request({
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/images/${siteImageId}/usage`,
                method: "GET",
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
 ...
 qs: {
    ...
    it('Attach Site Image In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/images/${siteImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
 ...
 qs: {
    ...
    it('Attach Site Image In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/images/${siteImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
 ...
 qs: {
    ...
    it('Attach Configured Image to Homepage resources and Check for Usage.(Should be Used)', () => {
        ...
        cy.then('Fetch for the Doc Usage.',()=>{
            cy.request({
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/image-config/${configuredImageId}/usage`,
                method: "GET",
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
 ...
 qs: {
    ...
    it('Attach Configured Image In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/images/${configuredImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
 ...
 qs: {
    ...
    it('Attach Configured Image In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/landing-pages/${baseConfig.resellerLandingPageId}/images/${configuredImageId}`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
