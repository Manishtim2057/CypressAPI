...
describe('View Usage of Contact with Master admin permission', () => {
    let contactId;
    ...
    before('Login With SiteAdmin permission', () => {
        cy.request({
        ...
        cy.then('Create the Site Contact', () => {
            ...
            cy.request({
                ...
                expect(response.body.body).to.have.property('id');
                siteContactId = response.body.body.id;
                cy.readFile('cypress/fixtures/variables.json').then((data) => {
    ...
    it('Attach Global Contact In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contacts/${globalContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
    ...
    it('Attach Global Contact In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/${globalContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
    ...
    it('Attach Site Contact to Homepage resources and Check for Usage.(Should be Used)', () => {
        ...
        cy.then('Fetch for the Doc Usage.',()=>{
            cy.request({
                ...
                cy.log('Sites Response:', JSON.stringify(response));
                expect(response.status).to.eql(200);
                expect(response.body.body.homepage_resources[0].id).to.eql(siteContactId);
    ...
    it('Attach Site Contact In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contacts/${siteContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
    ...
    it('Attach Site Contact In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/${siteContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
    ...
    it('Attach Configured Contact In Site Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contacts/${configuredContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
    ...
    it('Attach Configured Contact In Landing Page and Check For Usage.(Should be Used)', () => {
        ...
        cy.request({
            method: 'POST',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/landing-pages/${baseConfig.landingPageId}/contacts/${configuredContactId}`,
            headers: {
                Authorization: `Bearer ${siteAdminAccessToken}`,
            },
            body: {
