...
it('Reorder Homepage resources with invalid Api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contactss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with invalid api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pagesss/${baseConfig.sitePageId}/contacts/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Reorder Homepage resource with valid Api and valid Method.', () => {
        ...
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/contacts`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
    ...
    it('Reorder Homepage Resources with Reseller Admin Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/contacts/${resellerResourceID1}`,
                body: {
                    "order": 2
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/contacts/${resellerResourceID2}`,
                body: {
                    "order": 4
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'GET',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/contacts`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                qs: {
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/contacts/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenResellerAdmin}`,
                        },
                        body: {
