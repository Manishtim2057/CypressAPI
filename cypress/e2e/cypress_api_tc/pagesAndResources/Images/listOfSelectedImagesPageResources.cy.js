import { baseConfig } from "../../../../fixtures/baseConfig";describe('Get Page Resources.', () => {
    ...
    it('Get Page Resources with Invalid api and Valid method', () => {
        ...
        cy.request({
            method: 'GET',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pagesss/${baseConfig.sitePageId}/images`,
            headers: {
    ...
    it('Get Page Resources with Invalid api and InValid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sitesss/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/images`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            failOnStatusCode: false,
