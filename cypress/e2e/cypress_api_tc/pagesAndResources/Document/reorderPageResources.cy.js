...
let resellerVersion;
describe('Attach Document on Pages and Resources.', () => {
    before(() => {
        cy.request({
            method: 'POST',
...
it('Reorder Homepage resources with invalid Api and valid method', () => {
        ...
        cy.request({
            method: 'PUT',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pages/${baseConfig.sitePageId}/documentss/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
    ...
    it('Reorder Homepage resources with invalid api and invalid method', () => {
        ...
        cy.request({
            method: 'PATCH',
            url: `${baseConfig.baseUrl}/sites/${baseConfig.siteId}/pagesss/${baseConfig.sitePageId}/documents/order`,
            headers: {
                Authorization: `Bearer ${accessToken}`,
            },
            body: {
    ...
    it('Reorder Homepage Resources with Reseller Admin Permission', () => {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/documents/${resellerResourceID1}`,
                body: {
                    "order": 2
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'POST',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/documents/${resellerResourceID2}`,
                body: {
                    "order": 4
                },
                qs: {
        ...
        cy.then(() => {
            ...
            cy.request({
                method: 'GET',
                url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/documents`,
                headers: {
                    Authorization: `Bearer ${accessTokenResellerAdmin}`,
                },
                qs: {
                ...
                if (Array.isArray(responseData)) {
                    ...
                    cy.request({
                        method: 'PUT',
                        url: `${baseConfig.baseUrl}/sites/${baseConfig.resellerSiteId}/pages/${baseConfig.resellerSitePageId}/documents/order`,
                        headers: {
                            Authorization: `Bearer ${accessTokenResellerAdmin}`,
                        },
                        body: {
